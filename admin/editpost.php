     ...
     <!-- CONTENT -->
            ...
            if (isset($title) && isset($cat) && isset($descp) ) {
                ...
                $query = "UPDATE works
                   ...
                   if ($updated_rows) {
                    $imgeSucc = "<h4 style='color:green;'>Your Post Uploaded Successfully.
                    </h4>";
                   
                 }else {
                  $imgeSucc = "<h4 style='color:green;'>Your Post Not Updated
                  </h4>";
                  }
      ...
      if ($update_rows) {
       echo   "<h4 style='color:green;'>Your Post  Updated
       </h4>";
      
      }else {
       echo "<h4 style='color:red;'>Your Post Not Updated
       </h4>";
      }    
