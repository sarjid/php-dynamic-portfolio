                ...
                <div class="content-header">
                    ...
                    <div class="leftside-content-header">
                        <ul class="breadcrumbs">
                            ...
                            </i><a href="javascript:avoid(0)">Fact</a></li>
                            <li><i class=" " aria-hidden="true">
                            </i><a href="javascript:avoid(0)">All fact</a></li>
                        </ul>
                    </div>
                </div>
                <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
    ...
    echo $submitsucc;
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <a href="addfact.php " class="btn btn-primary">Add Facts</a>
					...
					<?php 
						$qeury = "SELECT * FROM facts ORDER BY id DESC";
